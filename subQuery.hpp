...
public:
    ...
    vector<string> getQueryVec();    //得到查询语句
    size_t getQueryValNum();            //得到查询语句变量个数
    vector<string> getValNameVec();  //得到查询语句变量名
    size_t getCount();  //得到查询语句的值
    size_t getID();
    size_t getParentLeft();
    size_t getpParentRight();
    int getType();
